...
class MemoryEfficientSoftDiceLoss(nn.Module):
    def __init__(self, apply_nonlin: Callable = softmax_helper_dim1, batch_dice: bool = False, do_bg: bool = False, smooth: float = 1.,
                 ddp: bool = True):
        """
...
class SoftSkeletonize(torch.nn.Module):
    ...
    def soft_skel(self, img):
        # img = torch.sigmoid((img - 0.5) * 10)  # 경계를 강조하는 비선형 변환 적용
