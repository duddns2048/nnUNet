...
class nnUNetTrainer_topo_CLDC1(nnUNetTrainer):
    ...
    def _build_loss(self):
        ...
        loss = DC_and_CE_and_CLDC_loss({'batch_dice': self.configuration_manager.batch_dice, 'smooth': 1e-5, 'do_bg': False, 'ddp': self.is_ddp}, 
                                       {},
                                       {'iter_': 10, 'smooth': 1e-3, 'skeletonize_flag': 'topo', 'original_algo': True},
                                    weight_ce=lambda_ce, 
...
class nnUNetTrainer_topo_CLDC2(nnUNetTrainer):
    ...
    def _build_loss(self):
        ...
        loss = DC_and_CE_and_CLDC_loss({'batch_dice': self.configuration_manager.batch_dice, 'smooth': 1e-5, 'do_bg': False, 'ddp': self.is_ddp}, 
                                       {},
                                       {'iter_': 10, 'smooth': 1e-3, 'skeletonize_flag': 'topo', 'original_algo': False},
                                    weight_ce=lambda_ce, 
                                    weight_dice=lambda_dice, 
                                    weight_cldice=lambda_cldice, 
                                    ignore_label=self.label_manager.ignore_label, 
